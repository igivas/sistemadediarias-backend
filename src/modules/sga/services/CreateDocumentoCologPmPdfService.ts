...
@injectable()
class CreateDocumentoCologPmPdfService {
  constructor() {}
    ...
    const docDefinitions: TDocumentDefinitions = {
      ...
      footer(currentPage, pageCount) {
        return [
          ...
          { image: footerCeara, height: 80, width: 600, margin: [0, 60, 0, 0] },
        ];
      },
      ...
      content: [
        ...
        {
          text: `Eu, ${data.nomeRecebedor} pertencente a OPM ${data.opmRecebedor} recebi os seguintes itens de fardamento discriminados abaixo da unidade COLOG`,
          fontSize: 11,
          alignment: 'justify',
          margin: [0, 30, 0, 0],
        },
...
export default CreateDocumentoCologPmPdfService;
